...
if __name__ == '__main__':
    spark = SparkSession.builder.appName("routeMgmtSystem").master("local[*]").getOrCreate()
    ...
    parser.add_argument("-sbp", "--schema_base_path",
                        default=r"C:\Users\kagar\pyspark_projects\AIRLINE_FINAL_PROJECT\schema\route_schema",
    ...
    # Input file path
    input_file_path = fr"{base_path}\{source_name}\route.csv"  # CSV file path
    ...
    loading_bad_data = r"C:\Users\kagar\pyspark_projects\AIRLINE_FINAL_PROJECT\output\bad_data3"
