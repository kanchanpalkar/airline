...
if __name__ == '__main__':
    ...
    parser.add_argument("-sbp", "--schema_base_path",
                        default=r"C:\Users\kagar\pyspark_projects\AIRLINE_FINAL_PROJECT\schema\airline_schema",
    ...
    # Input file path
    input_file_path = fr"{base_path}\{source_name}\airline.csv"  # CSV file path
    ...
    loading_bad_data = r"C:\Users\kagar\pyspark_projects\AIRLINE_FINAL_PROJECT\output\bad_data"
