...
if __name__ == '__main__':
    spark = SparkSession.builder.appName("PlaneMgmtSystem").master("local[*]").getOrCreate()

    # Initialize parser using argparse
    parser = argparse.ArgumentParser()

    parser.add_argument("-s", "--source_name", default="plane", help="please provide source name/dataset name")
    parser.add_argument("-sbp", "--schema_base_path",
                        default=r"C:\Users\kagar\pyspark_projects\AIRLINE_FINAL_PROJECT\schema\plane_schema",
    ...
    # Input file path
    input_file_path = fr"{base_path}\{source_name}\plane.csv"  # CSV file path
    ...
    loading_bad_data = r"C:\Users\kagar\pyspark_projects\AIRLINE_FINAL_PROJECT\output\bad_data2"
